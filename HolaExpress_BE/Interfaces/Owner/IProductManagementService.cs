...
public interface IProductManagementService
{
    ...
    // Image Management
    Task<List<string>> UploadProductImagesAsync(int productId, List<IFormFile> images, int ownerId);
    Task<bool> DeleteProductImageAsync(int productId, int mediaId, int ownerId);
}
